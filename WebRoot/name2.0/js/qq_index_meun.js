...
var qq = {
		...
		qstyle:function(){
			...
			$("#qq_quri_Img").css({"width":"117px","height":"208px","background":"url(./name2.0/img/qq-psw_03.png) no-repeat"});
			...
			$("#qq_quri_xx").css({"border":"1px solid #EEEEEE","width":"15px","height":"14px","position":"absolute","top":"1px","right":"2px","background":"url(./name2.0/img/xx_xx.png) no-repeat 3px -3px","cursor":"pointer"});
		},
		qjsapt:function(){
		...
		qimg:function(){
			//$("#qq_quri_Img").html("<img src='./name2.0/img/qq-psw_03.png'/>");
			//$("#qq_quri_xx").html("<img src='./name2.0/img/xx_xx.png'/>");
		}
}